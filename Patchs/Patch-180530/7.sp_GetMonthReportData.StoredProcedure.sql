...
/****** Object:  StoredProcedure [dbo].[sp_GetMonthReportData]    Script Date: 2018/5/30 23:45:11 ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	Update @MonthReport Set EnergyProduction3=IsNull(Subtotal,0) From @MonthReport mr,MonthReportDet mrd
		Where mr.ShiftId=mrd.ShiftId And mrd.ReportId=@ReportId And mrd.Item='EnergyProduction3'
	...
	Update @MonthReport Set SubtotalRuntime3=IsNull(Subtotal,0) From @MonthReport mr, MonthReportDet mrd
		Where mr.ShiftId=mrd.ShiftId And mrd.ReportId=@ReportId And mrd.Item='SubtotalRuntime3'
	...
	Select ROW_NUMBER() OVER(Order By [Day]) As [Row],[Day],[Shift],Worker1,Worker2,EnergyProduction1,EnergyProduction2,EnergyProduction3,Biogas2GenSubtotal,Biogas2TorchSubtotal,SubtotalRuntime1,SubtotalRuntime2,SubtotalRuntime3 from @MonthReport
END
