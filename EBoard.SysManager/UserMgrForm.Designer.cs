namespace EBoard.SysManager
{
	partial class UserMgrForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.IsProtected = new System.Windows.Forms.DataGridViewTextBoxColumn();
			...
			this.dataGridViewUser.CellBeginEdit += new System.Windows.Forms.DataGridViewCellCancelEventHandler(this.dataGridViewUser_CellBeginEdit);
			...
			this.IsProtected.HeaderText = "IsProtected";
			this.IsProtected.Name = "IsProtected";
			this.IsProtected.Visible = false;
			// 
			// menuStrip1
			// 
			...
			this.changePwdToolStripButton.Margin = new System.Windows.Forms.Padding(5, 1, 5, 2);
			...
			this.refreshToolStripButton.Margin = new System.Windows.Forms.Padding(5, 1, 5, 2);
		...
		private System.Windows.Forms.DataGridViewTextBoxColumn IsProtected;
	}
}