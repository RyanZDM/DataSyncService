...
namespace Demo
{
	public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            CommunicationInfo.IpStr = "192.168.0.99";//给IpStr赋值LED控制卡的IP
            ...
            nResult = LedDll.LV_SetBasicInfo(ref CommunicationInfo, 2, 160, 80/*64, 32*/);//设置屏参，屏的颜色为2即为双基色，64为屏宽点数，32为屏高点数，具体函数参数说明见函数声明注示
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            int hProgram;//节目句柄
            hProgram = LedDll.LV_CreateProgram(160, 80, 2);//根据传的参数创建节目句柄，64是屏宽点数，32是屏高点数，2是屏的颜色，注意此处屏宽高及颜色参数必需与设置屏参的屏宽高及颜色一致，否则发送时会提示错误
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            int hProgram;//节目句柄
            hProgram = LedDll.LV_CreateProgram(160,80,/*64, 32,*/ 2);//根据传的参数创建节目句柄，64是屏宽点数，32是屏高点数，2是屏的颜色，注意此处屏宽高及颜色参数必需与设置屏参的屏宽高及颜色一致，否则发送时会提示错误
            //此处可自行判断有未创建成功，hProgram返回NULL失败，非NULL成功,一般不会失败
            ...
            nResult = LedDll.LV_AddMultiLineTextToImageTextArea(hProgram, 1, 1, LedDll.ADDTYPE_STRING, "上海灵信~~~~~", ref FontProp, ref PlayProp, 0, 0);//通过字符串添加一个多行文本到图文区，参数说明见声明注示
																																					  // temp
			nResult = LedDll.LV_AddMultiLineTextToImageTextArea(hProgram, 1, 1, LedDll.ADDTYPE_STRING, "line1\r\nline2", ref FontProp, ref PlayProp, 0, 0);//通过字符串添加一个多行文本到图文区，参数说明见声明注示
